## Before Executing this code Create a HBase Table of same name or if already exist then ignore.
## hbase shell
## list
## create "trip_records", "colfam1"
...
# Fill that will be ingesting in our Hbase
